    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/user')) {
            if (0 === strpos($pathinfo, '/users')) {
                // tbf_users_index
                if ($pathinfo === '/users') {
                    return array (  '_controller' => 'TBFBundle\\Controller\\usersController::indexAction',  '_route' => 'tbf_users_index',);
                }
                ...
                if ($pathinfo === '/users/add') {
                    return array (  '_controller' => 'TBFBundle\\Controller\\usersController::addAction',  '_route' => 'tbf_users_add',);
                }

                // tbf_users_modify
                if (0 === strpos($pathinfo, '/users/modify') && preg_match('#^/users/modify/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'tbf_users_modify')), array (  '_controller' => 'TBFBundle\\Controller\\usersController::modifyAction',));
                }
            ...
            if (0 === strpos($pathinfo, '/user/remove') && preg_match('#^/user/remove/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'tbf_users_remove')), array (  '_controller' => 'TBFBundle\\Controller\\usersController::removeAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/re')) {
            ...
            if (0 === strpos($pathinfo, '/result') && preg_match('#^/result(?:/(?P<id>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'tbf_search_result')), array (  '_controller' => 'TBFBundle\\Controller\\SearchController::resultAction',  'id' => 1,));
            }

            // tbf_registration
            if ($pathinfo === '/registration') {
                return array (  '_controller' => 'FOS\\UserBundle\\Controller\\RegistrationController::registerAction',  '_route' => 'tbf_registration',);
            }
        ...
        if (0 === strpos($pathinfo, '/log')) {
            if (0 === strpos($pathinfo, '/login')) {
                // tbf_login
                if ($pathinfo === '/login') {
                    return array (  '_controller' => 'FOS\\UserBundle\\Controller\\SecurityController::loginAction',  '_route' => 'tbf_login',);
                }
