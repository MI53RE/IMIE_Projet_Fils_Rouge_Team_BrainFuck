...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => '5432', 'dbname' => 'tbf_db', 'user' => 'postgres', 'password' => 'postgres', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\TBFBundle\\Entity'))), 'TBFBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('TBFBundle' => 'TBFBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d8d1a3b89b7ac06a972837e4b5a628a4c1c5dbc7d81ef1275dcd84972f69a5d4');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('TBFBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('TBFBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('TBFBundle\\Entity\\Users');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('TBFBundle\\Entity\\Users');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'TBFBundle\\Entity\\Users');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\TBFBundle/Resources/views'), 'TBF');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d34625345192363425ba4baeaa7cca12fe458425');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'd34625345192363425ba4baeaa7cca12fe458425',
            'locale' => 'en',
            ...
            'kernel.secret' => 'd34625345192363425ba4baeaa7cca12fe458425',
            ...
            'fos_user.model.user.class' => 'TBFBundle\\Entity\\Users',
