...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\TBF\\FrontBundle\\Entity'))), 'TBF\\FrontBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('TBFFrontBundle' => 'TBF\\FrontBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a7d2c21a5a0edd674ad2d1fe435c66af434c343d0fc260ebde82d3f0fdccda1f');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\TBF\\FrontBundle/Resources/views'), 'TBFFront');
        $instance->addPath(($this->targetDirs[3].'\\src\\TBF\\BackBundle/Resources/views'), 'TBFBack');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55d1f0b8b9ad82.33895128')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TBFFrontBundle' => 'TBF\\FrontBundle\\TBFFrontBundle',
                'TBFBackBundle' => 'TBF\\BackBundle\\TBFBackBundle',
            ),
