 ...
 */
class Users_Skills extends \TBFBundle\Entity\Users_Skills implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'TBFBundle\\Entity\\Users_Skills' . "\0" . 'id', '' . "\0" . 'TBFBundle\\Entity\\Users_Skills' . "\0" . 'users', '' . "\0" . 'TBFBundle\\Entity\\Users_Skills' . "\0" . 'skills', '' . "\0" . 'TBFBundle\\Entity\\Users_Skills' . "\0" . 'level');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Users_Skills $proxy) {
