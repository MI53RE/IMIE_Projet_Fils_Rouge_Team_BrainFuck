...
class Projects extends \TBFBundle\Entity\Projects implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'TBFBundle\\Entity\\Projects' . "\0" . 'id', '' . "\0" . 'TBFBundle\\Entity\\Projects' . "\0" . 'name', '' . "\0" . 'TBFBundle\\Entity\\Projects' . "\0" . 'description', '' . "\0" . 'TBFBundle\\Entity\\Projects' . "\0" . 'members', '' . "\0" . 'TBFBundle\\Entity\\Projects' . "\0" . 'state', '' . "\0" . 'TBFBundle\\Entity\\Projects' . "\0" . 'skills');
        }
